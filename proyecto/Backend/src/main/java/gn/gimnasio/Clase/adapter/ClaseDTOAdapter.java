...
public class ClaseDTOAdapter implements IConversionDTOAdapter<Clase, ClaseDTO> {
    ...
    public Clase dtoAEntidad(ClaseDTO dto) {
        ...
        try {
            ...
            // Nota: Las entidades relacionadas (Instructor, Categoria, Sala) 
            // deben ser establecidas por el servicio que use este adaptador
     ...
     * 
     * @param clase Entidad clase con instructor
     * @return Nombre completo del instructor o string vacío si no existe
     */
    private String construirNombreCompleto(Clase clase) {
    ...
    /**
     * Valida que la entidad no sea nula y tenga los campos mínimos requeridos.
     * 
    ...
    /**
     * Valida que el DTO no sea nulo y tenga los campos mínimos requeridos.
     * 
