...
# Configuración
DIR_DATASET = "dataset_vocales"    # Carpeta con las imágenes de las manos
...
checkpoint = ModelCheckpoint("modelo_vocales2.h5", monitor='val_loss', 
...
subprocess.run(["python", "entrenar3.py"])
subprocess.run(["python", "entrenar4.py"])
